...
public class StudentList {
    ...
    public static void listGrade(){
        ...
        Student<String,Double,Double> std1 = new Student<>("Wilma",76.5,80.0);
    ...
    public static void listMemberLibrary(){
        ...
        System.out.printf("%-10s || %3d  ||  %13s  %n",std1.getS(),std1.getU(),std1.getV());
        System.out.printf("%-10s || %3d  ||  %13s  %n",std2.getS(),std2.getU(),std2.getV());
        System.out.printf("%-10s || %3d  ||  %13s  %n",std3.getS(),std3.getU(),std3.getV());
